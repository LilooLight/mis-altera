...
function ColorSwatch({ color, label, hex }: { color: string; label: string; hex: string }) {
  return (
    <div className="flex flex-col items-center gap-2">
      <div className={`w-full h-16 rounded-lg ${color} border border-gray-200 dark:border-[#373E47]`} />
...
export function UIKitPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#161B22]">
      {/* Header */}
      <div className="border-b border-gray-200 dark:border-[#373E47] bg-white dark:bg-[#161B22] px-6 py-6">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <div className="bg-gray-50 dark:bg-[#30363D] rounded-lg px-3 py-2">
      ...
      <div className="flex">
        {/* Sidebar Nav */}
        <aside className="w-56 sticky top-0 h-screen bg-white dark:bg-[#161B22] border-r border-gray-200 dark:border-[#373E47] overflow-y-auto shrink-0">
              ...
              <button
                ...
                className={`w-full flex items-center gap-2.5 px-3 py-2 rounded-md text-left transition-all text-sm ${
                  activeSection === s.id
                    ...
                    : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#30363D]'
                }`}
              >
        ...
        <main className="flex-1 p-8 max-w-5xl space-y-16">
          ...
          <section id="colors">
            ...
            <ComponentDemo title="Фоны (Background)" code={`/* Page */\nbg-gray-50               /* Light page */\ndark:bg-[#161B22]        /* Dark page */\n\n/* Cards */\nbg-white                 /* Light card */\ndark:bg-[#21262D]        /* Dark card */\ndark:bg-[#30363D]        /* Dark table/header */\n\n/* Header */\nbg-white                 /* Light header */\ndark:bg-[#1C2128]        /* Dark header */\ndark:bg-[#161B22]        /* Dark sidebar */`}>
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                <ColorSwatch color="bg-white" label="Card (L)" hex="#FFFFFF" />
                <ColorSwatch color="bg-gray-50" label="Page (L)" hex="#F9FAFB" />
                <ColorSwatch color="bg-[#161B22]" label="Page (D)" hex="#0B1120" />
                <ColorSwatch color="bg-[#21262D]" label="Card (D)" hex="#151E2E" />
                <ColorSwatch color="bg-[#30363D]" label="Header (D)" hex="#1E293B" />
                <ColorSwatch color="bg-[#1C2128]" label="Sidebar (D)" hex="#0D1424" />
              </div>
            </ComponentDemo>

            <ComponentDemo title="Рамки (Borders)" code={`border-gray-200          /* Light borders */\ndark:border-[#373E47]    /* Dark borders */\nborder-[#5ecece]         /* Accent border */`}>
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="h-12 rounded-lg border-2 border-[#373E47] flex items-center justify-center">
                  <span className="text-[10px] font-mono text-gray-400">#373E47</span>
                </div>
          ...
          <section id="buttons">
            ...
            <div className="space-y-8">
              ...
              <ComponentDemo title="Secondary" code={`<button className="px-4 py-2 bg-gray-100 dark:bg-[#30363D] text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-[#373E47] transition-colors">\n  Отмена\n</button>`}>
                <button className="px-4 py-2 bg-gray-100 dark:bg-[#30363D] text-gray-700 dark:text-gray-200 text-sm font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-[#373E47] transition-colors">Отмена</button>
              </ComponentDemo>
              ...
              <ComponentDemo title="Ghost" code={`<button className="px-4 py-2 text-gray-600 dark:text-gray-400 text-sm font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors">\n  Ещё\n</button>`}>
                <button className="px-4 py-2 text-gray-600 dark:text-gray-400 text-sm font-medium rounded-lg hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors">Ещё</button>
              </ComponentDemo>

              <ComponentDemo title="Icon Button" code={`<button className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors">\n  <Settings className="w-5 h-5" />\n</button>`}>
                <div className="flex gap-3">
                  <button className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors"><Settings className="w-5 h-5" /></button>
                  <button className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors"><Bell className="w-5 h-5" /></button>
                  <button className="p-2 rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors"><Download className="w-5 h-5" /></button>
                </div>
              </ComponentDemo>
          ...
          <section id="inputs">
            ...
            <ComponentDemo title="Text Input" code={`<input className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece] transition-colors" placeholder="Введите текст..." />`}>
              <input className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece] transition-colors" placeholder="Введите текст..." />
            </ComponentDemo>

            <ComponentDemo title="Search Input (with icon)" code={`<div className="relative">\n  <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />\n  <input className="w-full pl-10 pr-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece]" placeholder="Поиск..." />\n</div>`}>
              <div className="relative">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
                <input className="w-full pl-10 pr-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece] transition-colors" placeholder="Поиск по ФИО..." />
              </div>
            </ComponentDemo>

            <ComponentDemo title="Textarea" code={`<textarea className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 resize-y min-h-[80px] focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece]" placeholder="Описание..." />`}>
              <textarea className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 placeholder:text-gray-400 resize-y min-h-[80px] focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece] transition-colors" placeholder="Опишите жалобы пациента..." />
            </ComponentDemo>

            <ComponentDemo title="Select / Dropdown" code={`<select className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece]">`}>
              <select className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-[#5ecece]/30 focus:border-[#5ecece]">
            ...
            <ComponentDemo title="Checkbox" code={`<label className="flex items-center gap-3 cursor-pointer">\n  <input type="checkbox" className="w-4 h-4 rounded border-gray-300 dark:border-[#373E47] text-[#5ecece] focus:ring-[#5ecece]/30" />\n  <span className="text-sm text-gray-700 dark:text-gray-300">Я согласен</span>\n</label>`}>
              <div className="space-y-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" checked={checkboxChecked} onChange={(e) => setCheckboxChecked(e.target.checked)} className="w-4 h-4 rounded border-gray-300 dark:border-[#373E47] text-[#5ecece] focus:ring-[#5ecece]/30 accent-[#5ecece]" />
            ...
            <ComponentDemo title="Toggle / Switch" code={`/* On */\nbg-[#5ecece]\n\n/* Off */\nbg-gray-300 dark:bg-[#373E47]`}>
              <div className="flex items-center gap-4">
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors ${toggleOn ? 'bg-[#5ecece]' : 'bg-gray-300 dark:bg-[#373E47]'}`}
                >
          ...
          <section id="tables">
            ...
            <ComponentDemo title="Data Table" code={`<div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] overflow-hidden">\n  <table className="w-full">\n    <thead>\n      <tr className="bg-gray-50 dark:bg-[#30363D]">\n        <th className="px-4 py-3 text-left text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">...</th>\n      </tr>\n    </thead>\n    <tbody className="divide-y divide-gray-100 dark:divide-[#373E47]/50">\n      <tr className="hover:bg-gray-50/50 dark:hover:bg-[#30363D]/30 transition-colors">...</tr>\n    </tbody>\n  </table>\n</div>`}>
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-[#373E47]/50">
                    <tr className="hover:bg-gray-50/50 dark:hover:bg-[#30363D]/30 transition-colors">
                    ...
                    <tr className="hover:bg-gray-50/50 dark:hover:bg-[#30363D]/30 transition-colors">
                      ...
                      <td className="px-4 py-3"><span className="inline-flex items-center gap-1 px-1.5 py-0.5 text-[10px] font-medium rounded-md bg-gray-100 dark:bg-[#30363D] text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-[#373E47]"><CheckCircle2 className="w-3 h-3" />Завершено</span></td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <ComponentDemo title="Standard Card" code={`<div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-6">\n  <h3 className="text-lg font-serif font-semibold text-gray-900 dark:text-gray-100">...</h3>\n  <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">...</p>\n</div>`}>
              <div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-6">
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <button className="px-3 py-1.5 text-xs font-medium rounded-md text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#30363D]">Закрыть</button>
                </div>
              </div>
            </ComponentDemo>

            <ComponentDemo title="Card with Gold Left Border (hover)" code={`<div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-6 hover:border-l-4 hover:border-l-[#5ecece] hover:shadow-md transition-all">`}>
              <div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-6 hover:border-l-4 hover:border-l-[#5ecece] hover:shadow-md transition-all cursor-pointer">
            ...
            <ComponentDemo title="Stats Cards Row" code={`<div className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-4">\n  <span className="text-[10px] font-bold uppercase tracking-wider text-gray-400 dark:text-gray-500">Label</span>\n  <span className="block text-2xl font-bold text-gray-900 dark:text-gray-100 mt-1">24</span>\n</div>`}>
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={stat.label} className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-4">
          ...
          <section id="modals">
            ...
            <ComponentDemo title="Modal Card Template" code={`/* Overlay */\n<div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center">\n\n/* Card */\n<div className="bg-white dark:bg-[#21262D] rounded-2xl border border-gray-200 dark:border-[#373E47] shadow-2xl max-w-md w-full mx-4">`}>
              <div className="bg-white dark:bg-[#21262D] rounded-2xl border border-gray-200 dark:border-[#373E47] shadow-2xl max-w-md w-full">
                {/* Header */}
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-[#373E47]">
                  <h3 className="text-lg font-serif font-semibold text-gray-900 dark:text-gray-100">Заголовок модала</h3>
                  <button className="p-1 rounded-md text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors">
                    <X className="w-4 h-4" />
                  </button>
                </div>
                {/* Body */}
                ...
                {/* Footer */}
                <div className="flex items-center justify-end gap-2 p-4 border-t border-gray-200 dark:border-[#373E47]">
                  <button className="px-4 py-2 text-sm font-medium rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#30363D] transition-colors">Отмена</button>
              ...
              <div className="bg-white dark:bg-[#21262D] rounded-2xl border border-gray-200 dark:border-[#373E47] shadow-2xl max-w-md w-full">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div>
                    ...
                    <textarea className="w-full px-3 py-2 bg-white dark:bg-[#1C2128] border border-gray-200 dark:border-[#373E47] rounded-lg text-sm placeholder:text-gray-400 min-h-[80px] focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-500" placeholder="Укажите причину..." />
                  </div>
                </div>
                <div className="flex items-center justify-end gap-2 p-4 border-t border-gray-200 dark:border-[#373E47]">
          ...
          <section id="badges">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {[
                ...
                { label: 'Ожидает', cls: 'bg-gray-100 dark:bg-[#30363D] text-gray-600 dark:text-gray-400 border-gray-200 dark:border-[#373E47]', Icon: Clock },
                ...
                { label: 'Бесплатно', cls: 'bg-gray-100 dark:bg-[#30363D] text-gray-600 dark:text-gray-400 border-gray-200 dark:border-[#373E47]', Icon: Check },
                ...
                <div key={badge.label} className="bg-white dark:bg-[#21262D] rounded-xl border border-gray-200 dark:border-[#373E47] p-4">
              ...
              <div className="grid grid-cols-6 sm:grid-cols-8 lg:grid-cols-12 gap-4">
                {[
                  ...
                  <div key={name} className="flex flex-col items-center gap-1.5">
                    <div className="w-10 h-10 rounded-lg bg-gray-100 dark:bg-[#30363D] flex items-center justify-center">
          ...
          <section id="navigation">
            ...
            <ComponentDemo title="Tab Navigation" code={`<div className="flex items-center gap-1 bg-gray-100 dark:bg-[#30363D] rounded-lg p-1">\n  <button className="px-4 py-2 text-sm font-medium rounded-md bg-white dark:bg-[#21262D] text-[#5ecece] shadow-sm">Active</button>\n  <button className="px-4 py-2 text-sm font-medium rounded-md text-gray-600 dark:text-gray-400">Inactive</button>\n</div>`}>
              <div className="flex items-center gap-1 bg-gray-100 dark:bg-[#30363D] rounded-lg p-1">
                <button className="px-4 py-2 text-sm font-medium rounded-md bg-white dark:bg-[#21262D] text-[#5ecece] shadow-sm">Хронология</button>
                <button className="px-4 py-2 text-sm font-medium rounded-md text-gray-600 dark:text-gray-400">Документы <span className="ml-1 px-1.5 py-0.5 rounded text-[10px] font-bold bg-gray-200 dark:bg-[#373E47]">6</span></button>
            ...
            <ComponentDemo title="Sidebar Nav Item (Active)" code={`<button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md\n  bg-[#5ecece]/10 dark:bg-[#5ecece]/15 text-[#5ecece] border-l-2 border-[#5ecece]">`}>
              <div className="max-w-[220px]">
                ...
                <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-[#30363D] border-l-2 border-transparent mt-0.5">
            ...
            <ComponentDemo title="View Switcher" code={`<div className="flex items-center gap-1 bg-gray-100 dark:bg-[#30363D] rounded-lg p-0.5">\n  <button className="px-3 py-1.5 text-xs font-medium rounded-md bg-white dark:bg-[#21262D] text-[#5ecece] shadow-sm">Card</button>\n  ...\n</div>`}>
              <div className="flex items-center gap-1 bg-gray-100 dark:bg-[#30363D] rounded-lg p-0.5">
                {['Карточки', 'Список', 'Таблица'].map((v, i) => (
                  <button key={v} className={`px-3 py-1.5 text-xs font-medium rounded-md transition-colors ${i === 0 ? 'bg-white dark:bg-[#21262D] text-[#5ecece] shadow-sm' : 'text-gray-600 dark:text-gray-400'}`}>{v}</button>
                ))}
              </div>
            </ComponentDemo>
